...
// en 5 minutes = 72157600047687564
	// info http://www.flickr.com/services/api/misc.urls.html
	$.getJSON("http://api.flickr.com/services/rest/?method=flickr.photosets.getPhotos&photoset_id=72157640089367186&api_key=0120d5b1ebad15c8364c1c646e977d92&user_id=93823488@N00&format=json&callback=?",function(data){
			...
			for (var i = 0 ; i < limit; i++) {
				...
				$("#main-content").prepend(
						"<li class='photo-container'>\n\
							<a href='' id='desc-"+i+"'>\n\
								<img class='thumbnail-photo' src='js/vendor/unveil-master/img/loader.gif' data-src='"+url.small+"' data-src-retina='"+url.small+"'/>\n\
								<p class='photo-title'>"+data.photoset.photo[i].title+"</p>\n\
							</a>\n\
						</li>");
				getDesc(data.photoset.photo[i],url,i); // will add description to photo by using desc-0 ID when callback is done
...
function getDesc(photo,url,i){
	$.getJSON("http://api.flickr.com/services/rest/?method=flickr.photos.getInfo&api_key=0120d5b1ebad15c8364c1c646e977d92&photo_id="+photo.id+"&format=json&nojsoncallback=1",function(data){
		//console.log(data)
...
// http://api.flickr.com/services/rest/?tags=infographics&method=flickr.people.getPublicPhotos&api_key=0120d5b1ebad15c8364c1c646e977d92&user_id=93823488@N00&format=json&jsoncallback=?
